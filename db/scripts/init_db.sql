...
-- PostgreSQL 15+
-- Для тестирования: удаляет и создает БД заново при каждом запуске
-- ============================================================

-- Удаляем базу данных если существует (для чистого теста)
DROP DATABASE IF EXISTS library;

-- Создаем свежую базу данных
CREATE DATABASE library OWNER postgres ENCODING 'UTF8';
